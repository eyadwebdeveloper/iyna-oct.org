$(function () {
    ...
    fetch(`js/issue${$("body").attr("issue-no")}_references.json`)
      .then((response) => {
    ...
    $(".copy-section-link").on("click", function () {
      ...
      navigator.clipboard.writeText(`https://www.iyna-oct.site/issue_1#articles?article=${parseInt(sectionHref[1]) - 1}`);
